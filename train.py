...
from dataset.graspnet_dataset import GraspNetDataset, GraspNetDataset_fusion, load_grasp_labels_ann, minkowski_collate_fn, load_grasp_labels
...
grasp_labels = load_grasp_labels_ann(cfgs.dataset_root)
