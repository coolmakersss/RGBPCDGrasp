...
def inference():
    test_dataset = GraspNetDataset_fusion(cfgs.dataset_root, valid_obj_idxs=None, grasp_labels=None, split='test_seen', camera=cfgs.camera,
                               num_points=cfgs.num_point, remove_outlier=True, augment=False, load_label=False, use_fine=False, exfeature='dinov2')
