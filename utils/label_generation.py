...
def process_grasp_labels(end_points):
    ...
    for i in range(batch_size):
        ...
        for obj_idx, pose in enumerate(poses):
            ...
            #print((grasp_scores>0).sum().item())
            #print(grasp_widths.shape)
            #print(grasp_points)
            ...
            #print(grasp_scores.shape," ",(grasp_scores>0).sum().item())
            # add to list
        ...
        #print(grasp_scores_merged.shape," ",grasp_scores_merged.sum())
    ...
    # process scores
    #print("@",batch_grasp_scores.shape," ",batch_grasp_scores, " ",batch_grasp_scores.sum())
    #print(batch_grasp_widths)
